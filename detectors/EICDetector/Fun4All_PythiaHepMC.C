...
//    const char *inputFile = "phpythia8_ep_MB.cfg",
//    const char *outputFile = "data/phpythia8_ep_MB"//
        const char *inputFile = "phpythia8_BeamGas_MDC1.cfg",
        const char *outputFile = "data/phpythia8_BeamGas_MDC1"//
        )
{
